  ...
  return (
    <Motion>
      <Wrapper className="!max-w-[1500px]">
        ...
        <section>
          <div
            className="w-full h-[700px] object-cover bg-center m-0 flex flex-col justify-between"
            style={{
          ...
          >
            ...
            <div className="text-white m-10 max-w-[550px] space-y-4">
              ...
              <BodyText className="!text-p4">
                Turn your passion for hosting into a rewarding experience!
                Create unforgettable gatherings, connect with vibrant
                communities, and earn while doing what you love.
              </BodyText>
