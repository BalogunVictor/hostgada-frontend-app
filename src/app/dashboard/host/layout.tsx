  ...
  return (
    <Motion>
      <div className="flex w-full">
        {/* Sidebar */}
        <div className="hidden fixed inset-0 xl:w-64 2xl:w-80 h-screen lg:flex flex-col shadow-xl bg-white">
              ...
              {links.map((link) => {
                ...
                return (
                  <li className="group relative mr-8" key={link.name}>
                    ...
                    >
                      <link.icon />
                      <p className="mx-4 block md:hidden lg:block">
                        {link.name}
                      </p>
                    </Link>
                    {isActive && (
        ...
        {/* Main content */}
        <div className="flex-1 xl:ml-64 2xl:ml-80 space-y-4">
          <HostHeader />
